...
def cubic_follow_profile(path, start_speed, desired_speed, acc_max, lead_car_state, time_gap=4.0):
...
def cubic_nominal_profile(path, start_speed, desired_speed, acc_max, time_gap=4.0):
