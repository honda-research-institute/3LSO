...
class PathOptimizer:
    ...
    def optimize_spiral(self, xf, yf, tf):
        ...
        bounds = ((-0.5, 0.5),(-0.5, 0.5),(sf_0, None)) ## THIS MIGHT BE THE PARAM FOR HIGHWAY MERGING
    ...
    def sample_spiral(self, p):
        ...
        s_points = np.linspace(0.0, p[4], int(p[4]/0.2))
        ...
        return [x_points.tolist(), y_points.tolist(), t_points[1:].tolist()] ## remove initial zero theta
        # ------------------------------------------------------------------
